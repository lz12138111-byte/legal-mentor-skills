...
首个技能 `cn-criminal-defense` 面向中国刑事案件，支持：
...
仓库使用完全虚构、无个人信息的测试输入覆盖案件分析、诈骗金额拆分、取保方案、走私主观明知分析和庭审提问生成。测试用例与验收点见 [tests/TEST_CASES.md](tests/TEST_CASES.md)，本版结果见 [tests/RESULTS.md](tests/RESULTS.md)。
